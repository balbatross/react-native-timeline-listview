  ...
  _renderTime(rowData, sectionID, rowID) {
      ...
      return (
        ...
        <View style={[styles.timeContainer, this.props.timeContainerStyle]}>
          <Text style={[styles.time, this.props.timeStyle]}>{this._convertFromUnix(rowData.time)}</Text>
         <Text style={[styles.time, this.props.dateStyle]}>{this._convertDateFromUnix(rowData.time)}</Text>
        </View>
        </View>
      )
  }

   _convertDateFromUnix(time){
